...
//   var lyricModel = LyricsModelBuilder.create().bindLyricToMain(normalLyric).bindLyricToExt(transLyric).getModel();
...
//                   lyricModel = LyricsModelBuilder.create().bindLyricToMain(value ? advancedLyric : normalLyric).bindLyricToExt(transLyric).getModel();
//                 });
//               }),
...
//   Text buildTitle(String title) => Text(title, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green));
// }
